...
function fe(e){return` <li class="swiper-slide">
        ...
        </li>`}function ge(e){return e.map(fe).join("")}const we=ge(B);pe.innerHTML=we;//!=======================================================================
